(function () {
    ...
    function describeEffect(item) {
        ...
        if (item.effect_type === "dust_convert") {
            ...
            return isGuaranteed
                ? "기능: 강화 성공/유지/파괴 확률이 사라지고, 성급과 상관없이 인물 3장이 먼지 1개로 바뀝니다. 다른 강화 아이템과 함께 사용할 수 없습니다."
                : "기능: 강화 성공/유지/파괴 확률이 사라지고, 성급별 확률로 인물 3장이 먼지 1개로 바뀝니다. 다른 강화 아이템과 함께 사용할 수 없습니다.";
        }
        return "";
    }
