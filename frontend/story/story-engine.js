...
const ENDINGS = {
  ...
  '3-2': {
    ...
    lines:[
      ...
      {type:'narration', text:'그 순간, 녀석의 넓은 어깨와 굳은살 박힌 주먹, 그리고 오랫동안 단련된 특유의 매서운 체구와 눈빛이 그제야 눈에 들어왔다.', showBg:'end1_cg', noBgFade:true, impact:true, chars:{left:null, right:null}, bgm:'Hurting Boxing'},
      {type:'narration', text:'(……!!!)'},
...
/* =========================================================
   ...
   ========================================================= */
const SCENE3_INTRO = [
  {type:'narration', text:'연속되는 자습 시간 속에 지루함을 달래줄 체육 시간이 시작됐다.', showBg:'gym', chars:{left:null, right:null}},
...
const SCENE3_BRANCHES = {
  '1': {
    ...
    lines:[
      ...
      {type:'thought', text:'그런데 저기 보이는 상대 골기퍼 3학년 선배의 기분이 안좋아 보인다?', chars:{left:'seungyu', right:'senior_sil'}},
    ]
  },
  '2': {
    seungyu:-1, yeongwoong:+1,
    lines:[
      ...
      {type:'narration', text:'이번 학기 체육 수행평가는 조금 힘들 것 같다.'},
    ]
  },
  '3': {
    ...
    lines:[
      ...
      {type:'narration', text:'승유가 황당하다는 듯 한숨을 쉬며 내 어깨를 툭 친다.'},
    ]
  },
};
...
const SCENE3B_BRANCHES = {
  '1': {
    ...
    lines:[
      {type:'line', speaker:PLAYER, text:'희야! 힘내보자! 너 수비 완전 김민재급이던데, 우리 할 수 있어!'},
      {type:'narration', text:'그 말이 끝나자마자, 강희는 나에게 얼굴을 돌리고 성큼성큼 다가온다.', chars:{left:null, right:'ganghee'}},
      {type:'narration', text:'그 후, 얼굴에 희번뜩한 미소를 띄우며 말을... 말을 하기 시작했다.'},
      {type:'line', speaker:GANGHEE, text:'어? 그래? 그러자. 우리 잘할 수 있어. 아니, 무엇보다 내가 잘 할 수 있지. 나는 잘하니까.'},
      {type:'line', speaker:GANGHEE, text:'어제 다른 반이랑 경기한 거 봤어? 그때 내가 상대편 공 다 뺐어서 점유율 개발랐었는데.'},
      {type:'line', speaker:GANGHEE, text:'그때 더군다나 3학년 선배들이랑 해서 벨런스도 안 맞을뻔했지 뭐야.'},
      {type:'line', speaker:GANGHEE, text:'왜 안 맞은게 아니고, 안 맞을 뻔했냐고? 내가 우리 팀에 떡하니 있는데 어떡해. 상대 팀도 받아들여야지.'},
      {type:'line', speaker:GANGHEE, text:'그나저나 이러고 저러고 그러고 이래서 이렇고...'},
      {type:'narration', text:'(...)'},
      {type:'narration', text:'(...)'},
      {type:'thought', text:'난 한마디 했다.'},
    ]
  },
  '2': {
    ...
    lines:[
      ...
      {type:'narration', text:'경기는 무승부로 막을 내렸고, 수행평가에서 감점 당하지 않을 수 있었다.'},
    ]
  },
  '3': {
    ...
    lines:[
      ...
      {type:'narration', text:'(!!!)'},
      {type:'narration', text:'(...)'},
      {type:'thought', text:'그렇다. 현실은 판타지 세계가 아니다. 빙의할 수 있을 리가 없다.'},
      ...
      {type:'thought', text:'내 모습은 비참했지만, 이 정도면 청신호로 여겨지니 일단은 이걸로 된걸까.'},
    ]
  },
};
...
/* =========================================================
   ...
   ========================================================= */
const SCENE4B_INTRO = [
  {type:'narration', text:'얼마 후, 학교 최대 행사 중 하나인 부고컵 축구 대회날이 다가왔다.', showBg:'field'},
...
const SCENE4B_OUTCOMES = {
  '1': {
    ...
    lines:[
      ...
      {type:'narration', text:'승유가 디딤발을 딛는 순간— 악 소리도 내지 못한 채 발목에 무리가 간 듯 중심이 무너졌다.'},
      {type:'narration', text:'툭 건드려진 공은 힘없이 굴러가 상대 골키퍼의 품에 허무하게 안겼다.'},
      {type:'narration', text:'실축이다.'},
      {type:'line', speaker:SEUNGYU, text:'미안하다, 얘들아... 진짜 발목이 안 따라주네...'},
      ...
      {type:'narration', text:'승유는 미안함에, 주헌이는 아쉬움에 젖어 들었을 뿐, 서로를 탓하지도 특별히 가까워지지도 않은 채 분위기만 무거워졌다.'},
    ]
  },
  '2': {
    ...
    lines:[
      ...
      {type:'narration', text:'이기고 싶었던 마음이 컸던 만큼, 자신에게 기회를 준 나에게도 묘한 부담감과 짜증이 섞인 듯 호감도가 뚝 떨어지는 소리가 들렸다.'},
    ]
  },
  '3': {
    juheon:+1, seungyu:+1, ganghee:+1,
    lines:[
      {type:'narration', text:'나는 벤치에서부터 몸을 풀며 온갖 호들갑을 떨고 있던 강 희에게 공을 쥐여주었다.', chars:{left:null, right:'ganghee'}},
      {type:'line', speaker:PLAYER, text:'강 희, 널 믿는다. 가서 꽂고 와라.'},
      {type:'line', speaker:GANGHEE, text:'하하하! 드디어 이 부고의 위대한 구세주이자 주인공인 강 희 님의 진가를 알아보는구나!'},
      ...
      {type:'narration', text:'부상으로 앓던 승유도 "와, 대박이다 진짜 ㅋㅋㅋ" 하며 환하게 웃었고, 주헌이도 기분이 좋아 보였다.'},
    ]
  }
};
...
const SCENE4_OUTCOMES = {
  a: {
    seungyu:+1, yeongwoong:-1,
    lines:[
      {type:'narration', text:'이영웅의 발이 공에 닿는 순간, 나는 본능적으로 몸을 웅장하게 던졌다.'},
      {type:'narration', text:'퍽-!!'},
      {type:'narration', text:'둔탁한 파열음과 함께 내 손끝에 강렬한 저항감이 느껴졌다.'},
      {type:'narration', text:'공은 내 손을 맞고 그대로 라인 밖으로 튕겨 나갔다. 슈퍼 세이브다!'},
  ...
  b: {
    ...
    lines:[
      ...
      {type:'narration', text:'공은 골대를 맞고 그대로 라인 밖으로 튕겨 나갔다.'},
      {type:'line', speaker:YEONGWOONG, text:'아, X발... 그걸 읽었다고?'},
      {type:'narration', text:'큰 머리를 감싸 쥐며 허탈하게 지면을 내려다본다.'},
      {type:'narration', text:'스탠드에서 경기를 보던 반 애들이 오오오!! 하며 단체로 소리를 지른다.'},
      {type:'narration', text:'관중석의 열기가 순식간에 뒤집혔다.'},
  ...
  c: {
    ...
    lines:[
      {type:'narration', text:'이영웅의 디딤발 각도가 내가 움직이는 방향을 향하는 것을 포착했다.'},
      ...
      {type:'narration', text:'디딤발 각도까지 페이크였던 것이다. 완벽하게 낚였다..'},
...
const SCENE5_SEUNGYU_INTRO = [
  {type:'narration', text:'축구 대회가 끝나고 온몸이 모래투성이에 뻐근하기 짝이 없다.'},
  {type:'narration', text:'승유 녀석이 갑자기 시원한 거나 마시자며 나를 반죽동 829 카페로 반강제로 끌고 왔다.', showBg:'banjukdong', chars:{left:'seungyu', right:null}},
...
const SCENE5_SEUNGYU_OUTCOMES = {
  '1': {
    ...
    lines:[
      ...
      {type:'thought', text:'딱 평타 치는 평화로운 휴식 시간이다.'},
    ]
  },
  '2': {
    seungyu:0,
    lines:[
      ...
      {type:'narration', text:'묘한 메뉴 초이스 덕분에 대화 소재가 잠깐 음료수 맛 평가로 튀었을 뿐, 이내 다시 축구 얘기로 자연스럽게 넘어가며 무난하게 마무리되었다.'},
    ]
  },
  '3': {
    seungyu:+1,
    lines:[
      {type:'narration', text:'지친 몸에는 역시 당 충전이 필수다. 달달하고 부드러운 바닐라 라떼를 선택했다.'},
      {type:'line', speaker:SEUNGYU, text:'헉...! 너 방금 바닐라 라떼라고 했냐? 헐, 대박. 너 뭘 좀 아는 새끼구나?!'},
      ...
      {type:'thought', text:'달콤한 라떼 향만큼 승유와의 거리도 부쩍 좁혀진 기분이다. 오늘 메뉴 선택은 대성공이다.'},
    ]
  }
};
...
const SCENE5_JUHEON_INTRO = [
  {type:'narration', text:'축구 대회가 끝나고 며칠 뒤, 유독 지쳐 보이는 주헌이를 데리고 반죽동 328에 위치한 조용한 카페로 들어왔다.', showBg:'banjukdong', chars:{left:null, right:'juheon'}},
  {type:'narration', text:'통유리창 너머로 지는 노을이 카페 안을 은은하게 비추고 있다.'},
...
const SCENE5_JUHEON_OUTCOMES = {
  '1': {
    ...
    lines:[
      ...
      {type:'narration', text:'녀석의 진중하고 담백한 성격에 딱 들어맞는 씁쓸하고 시원한 티타임 덕분에, 주헌이와의 유대감이 한층 더 깊고 단단해진 기분이다.'},
    ]
  },
  '2': {
    juheon:0,
    lines:[
      ...
      {type:'narration', text:'고개를 갸웃거리는 주헌이. 새로운 경험을 시켜주긴 했지만 녀석의 확고한 취향을 저격하진 못해, 대화는 그저 아샷추 맛에 대한 기묘한 감상평으로 흘러가며 무난하게 마무리되었다.'},
    ]
  },
  '3': {
    juheon:0,
    lines:[
      ...
      {type:'narration', text:'기운을 북돋아 주려던 내 의도와 달리 녀석의 현재 기분 상태를 완벽하게 파악하지 못한 것 같아 미안한 정적이 감돈다.'},
    ]
  }
};
...
const SCENE6_JUHEON_LOW_INTRO = [
  {type:'narration', text:'주헌이와 카페에서 속 깊은 이야기를 나눈 뒤로, 녀석은 전보다 나를 훨씬 편하게 대하기 시작했다.'},
...
const SCENE6_JUHEON_HIGH_ENDING = [
  {type:'narration', text:'그 다사다난했던 사건들이 지나간 뒤, 내 삶은 언제 그랬냐는 듯 평범하고 무던한 학교 생활로 돌아왔다.', showBg:'schoolgate', chars:{left:null, right:null}},
  ...
  {type:'thought', text:'그리고 지금 내 세상에서, 나를 가장 단단하고 온전하게 지탱해 주는 그 고마운 존재는 바로 주헌이다.', showBg:'juheon_end_photo', chars:{left:null, right:null}},
...
const SCENE6_JUHEON_HIDDEN_INTRO = [
  {
    ...
    text:'주헌이가 소개해준 학생이 너니? 이름은 "__PLAYER_NAME__"라고 들었는데 맞아?',
    showBg:'schoolgate',
...
mysterySpeaker:true,
  ...
  {type:'line', speaker:YOONDAEWOONG, text:'나는 우정이 깃든 아름다운 세상을 사진첩에 담는 사진 작가 윤대웅이라고 해.'},
...
const SCENE5_YEONGWOONG_INTRO = [
  ...
  {type:'narration', text:'그 거대한 실루엣이 내 앞을 턱 가로막았다.'},
...
const SCENE5_YEONGWOONG_OUTCOMES = {
  '1': {
    yeongwoong:-1,
    lines:[
      {type:'line', speaker:YEONGWOONG, text:'안녕 안하지 새끼야. 네가 기분 다 말아먹었는데, 골때리는 새끼네. 이거'},
  ...
  '2': {
    ...
    lines:[
      ...
      {type:'narration', text:'그러고 그냥 주머니에 손을 꽂은 채 골목 저편으로 사라졌다.'},
    ]
  }
};
...
const SCENE6_SEUNGYU_INTRO = [
  {type:'narration', text:'치열했던 축구 대회의 여운도 완전히 가시고, 평화롭다 못해 지루한 일상으로 돌아왔다.'},
...
const SCENE_COLLECTOR_ENDING = [
  ...
  {type:'timecard', text:'10년 후...', nextBg:'collector_spring'},
  ...
  {type:'line', speaker:SEUNGYU_ADULT, text:'야! 너 왔냐?! 봤지? 이 형님이 세계 최연소 챔피언 타이틀 또 지켜내는 거! 나 아직 안 죽었다니까!', showBg:'true_seungyu_cg', chars:{left:null, centerLeft:null, centerRight:null, right:null}},
  ...
  {type:'narration', text:'녹색 수술복을 입고 청진기를 목에 걸은 채, 수많은 차트와 모니터 사이를 바쁘게 오가는 녀석.', showBg:'true_ganghee_cg'},
  ...
  {type:'narration', text:'원장실 문을 열고 들어가자, 고급스러운 원목 책상 뒤에서 맞춤 정장을 차려입은 영웅이 형이 나를 반갑게 맞이해 주었다.', showBg:'true_yeongwoong_cg'},
  ...
  {type:'narration', text:'완벽하게 재단된 슈트를 입고 ‘ester CAD’의 CEO로서 묵직한 아우라를 풍기는 주헌이.', showBg:'true_juheon_cg'},
...
const SCENE_GANGHEE_ENDING = [
  ...
  {type:'thought', text:'그렇게 서로의 일상에 스며들다 보니, 어느새 우리는 서로가 서로에게 자연스럽게 기댈 수 있고 마음을 터놓을 수 있는 든든한 의지의 존재가 되어 있었다.', showBg:'ganghee_end_photo', chars:{left:null, right:null}},
...
const SCENE6_NORMAL_ENDING = [
  ...
  {type:'thought', text:'아직 세상에는 내가 알지 못하는 수많은 부류의 사람들이 존재하고, 내가 경험해 보지 못한 아득히 넓은 세계가 나를 기다리고 있다.', showBg:'normal_end_photo', chars:{left:null, right:null}},
...
const SCENE6_YEONGWOONG_INTRO = [
  ...
  {type:'narration', text:'나는 휴대폰을 들고 영웅 선배의 카톡 창을 켰다.', openChat:'yeongwoong'},
...
const SCENE6_YEONGWOONG_OUTCOMES = {
  '1': {
    ...
    lines:[
      ...
      {type:'narration', text:'도발에 부들부들 떠는 이영웅이었다.', closeChat:true},
    ]
  },
  '2': {
    yeongwoong:-1,
    lines:[
      ...
      {type:'narration', text:'(...)'},
      {type:'narration', text:'그렇게 영웅 선배한테 차단당한 오늘이었다.'},
    ]
  }
};
...
const SCENE6_YEONGWOONG_HIGH_ENDING = [
  ...
  {type:'thought', text:'그리고 지금 내 삶에서, 나를 가장 단단하게 지탱해 주는 그 의지되는 존재가 바로 영웅이 형이다.', showBg:'yeongwoong_end_photo', chars:{left:null, right:null}},
...
function setCharacterSlot(container, image, key){
  if(key){
...
function setChars(chars){
  ...
  if('left' in chars){
    ...
    setCharacterSlot(el.charLeft, el.charLeftImg, chars.left);
  }
  ...
  if('right' in chars){
    ...
    setCharacterSlot(el.charRight, el.charRightImg, chars.right);
  }
